                ...
                <div class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content">
                    <form method="get" class="col-md-6">
                        <div class="md-form mt-0">
                            <input class="form-control" type="text" name="title" placeholder="Search" aria-label="Search">
                    ...
                    <table class="table">
                        ...
                        <?php foreach ($rows as $r) { ?>
                            <tr>
                                ...
                                <td><?=$r['description']?></td>
                                <td><?=$r['moy']?></td>
                                <td><a href="/src/item/note.php?id=<?=$r['id']?>" class="btn btn-primary">Noter</a><a href="/src/item/show.php?id=<?=$r['id']?>" class="btn btn-primary">Voir</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
